          ...
          ? Container(
              ...
              child: ListView(
                children: [
                  ...
                  ListView.builder(
                      shrinkWrap: true,
                      itemCount: myRewardController.myRewardModel.value.data!
                          .rewardDetails!.data!.length,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        "${AppTags.quantity.tr}: ${myRewardController.myRewardModel.value.data!.rewardDetails!.data![index].productQty}",
                                        style: AppThemeData.walletTextStyle_12,
                                      ),
                                      Text(
                                          "${AppTags.totalRewards.tr}: ${myRewardController.myRewardModel.value.data!.rewardDetails!.data![index].reward}",
                                          style: AppThemeData
                                              .buttonDltTextStyle_12),
                                    ],
                                  ),
